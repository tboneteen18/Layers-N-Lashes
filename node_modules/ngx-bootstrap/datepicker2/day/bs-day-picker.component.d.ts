...
export declare class BsDayPickerComponent extends DatePickerBase {
    calendar: DatePickerDate[][];
    viewMonth: string;
    viewYear: string;
    weeks: number[];
    locale: any;
    private cOptions;
    constructor(datePickerState: BsDatePickerState, options: BsDatePickerOptions, cOptions: BsCalendarOptionsClass);
    refresh(_viewDate: any): void;
}
